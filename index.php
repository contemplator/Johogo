...
<div class="container_12" >
	<div id="slider1_container" style="position: relative; top:0 px; left: 0px; width: 960px; height:450px;">
		...
		<div id="slider-jssor" u="slides" style="position: absolute; top:0 px; left: 0px; cursor: move; width: 960px; height: 400px; overflow: hidden;">
			...
			<div><img u="image" src="resource/ad_cp17.jpg" /></div>
			<div><img u="image" src="resource/ad_cp4.jpg" /></div>
			<div><img u="image" src="resource/ad_cp10.jpg" /></div>
			<div><img u="image" src="resource/ad_cp16.jpg" /></div>
			...
			<div><img u="image" src="resource/ad_cp15.jpg" /></div>
			...
			<div><img u="image" src="resource/ad_cp14.jpg" /></div>
...
<div class="container_12" style="margin-top: 0px;margin-bottom:80px">
			...
			while($result = $db->fetch_array()){
				...
				if($count == 1){
					...
					echo "<td style=\"text-align: center;\">\r\n" ;
						...
						echo "<div class=\"panel-title\">".mb_substr($result["p_name"], 0, 17, 'utf-8')."</div>\n\r".
							"</div>\r\n".
